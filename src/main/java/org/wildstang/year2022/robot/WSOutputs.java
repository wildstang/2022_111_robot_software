...
public enum WSOutputs implements Outputs {
    ...
    HOOD_MOTOR("Hood Motor", new WsPhoenixConfig(CANConstants.HOOD,WsMotorControllers.SPARK_MAX_BRUSHLESS)), //edit can constraints and maybe ws motor controllers
