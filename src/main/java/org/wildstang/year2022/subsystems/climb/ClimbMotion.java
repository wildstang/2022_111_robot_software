...
//         }
//         if(IsRotated){
//             RightSol.setValue(WsDoubleSolenoidState.FORWARD.ordinal()); //because initialized to .FORWARD, and i'm assuming starts not rotated.
//             LeftSol.setValue(WsDoubleSolenoidState.FORWARD.ordinal());
//         }
//         else{ 
//             RightSol.setValue(WsDoubleSolenoidState.REVERSE.ordinal());
...
//         SmartDashboard.putNumber("Climb encoder value", RightClimber.getPosition());
//         SmartDashboard.putBoolean("Climb is Rotated", IsRotated);
//         SmartDashboard.putBoolean("Climb is Extended", IsExtended);
//         SmartDashboard.putBoolean("Climb is AutoClimbing", autoState != AutoState.IDLE);
