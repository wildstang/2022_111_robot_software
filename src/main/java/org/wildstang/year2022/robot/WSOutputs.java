...
public enum WSOutputs implements Outputs {
    ...
    BALLPATH_FEED("Module 4 Angle Motor", new WsSparkMaxConfig(CANConstants.FEED, true)),
    BALLPATH_INTAKE("Module 4 Angle Motor", new WsSparkMaxConfig(CANConstants.INTAKE, true)),
    INTAKE_SOLENOID("Module 4 Angle Motor", new WsSparkMaxConfig(CANConstants.INTAKE_SOLENOID, true)),
